        ...
        const recipesGrid2x2 = [
            ...
            { pattern: [['planks', 'planks'], ['planks', 'planks']], result: { type: 'wooden_trapdoor', count: 1 } }
        ];
        ...
        const recipesGrid = [
            ...
            { pattern: [['planks', 'planks', null], ['planks', 'planks', null], ['planks', 'planks', null]], result: { type: 'wooden_door', count: 1 } },
            { pattern: [['planks', 'planks', null], ['planks', 'planks', null], [null, null, null]], result: { type: 'wooden_trapdoor', count: 1 } }
        ];
        ...
        window.updateChestUI = function() {
            ...
            if (!key || typeof blocks === 'undefined' || !blocks[key]) return;
            if (blocks[key].type === 'chest' && !blocks[key].inventory) blocks[key].inventory = new Array(27).fill(null);
            if (!blocks[key].inventory) return;
