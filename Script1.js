    ...
    function changerFichierCSS367() {
        ...
        styleSheet.href = "https://cdn.jsdelivr.net/gh/Polocrafting367/WindowsBlurry-1@master/WB367.css"; // Remplacez "NouveauFichier.css" par le nom de votre nouveau fichier CSS
    ...
    function phone(){
        ...
        styleSheet.href = "https://cdn.jsdelivr.net/gh/Polocrafting367/WindowsBlurry-1@master/WP.css"; // Remplacez "NouveauFichier.css" par le nom de votre nouveau fichier CSS
        bts.style.display = "none";
        bios.style.display = "none";
        var bouton = document.getElementById("download");
}
