...
function removePrefixedItem(key) {
    ...
    const prefix = getStoragePrefix(); // Récupérer le préfixe en fonction de l'utilisateur
    localStorage.removeItem(prefix + key); // Supprimer l'élément spécifique
}
...
if (
    ...
    const enregistrement = `${formattedDate} _ ${tempsAffiche} _ ${lieu} _ ${zoneTexteValue} _ ${zonePiecesValue} _ ${typeValue} _ ${causeValue} _ ${tempsArretValue}`;
